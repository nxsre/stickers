...
## [v1.4.0] (draft)
### ⚠ BREAKING CHANGES
- Moved `flexbox` and `table` into separate packages, `github.com/nxsre/stickers/flexbox` and `github.com/nxsre/stickers/table` respectively. #10 @jon4hz
### Fixes
- Minor lexical fixes
...
## [v1.3.0](https://github.com/nxsre/stickers/compare/v1.2.0...v1.3.0) (2022-12-28)
### Fixes
...
## [v1.2.0](https://github.com/nxsre/stickers/compare/v1.1.0...v1.2.0) (2022-02-27)
### Features
...
## [v1.1.0](https://github.com/nxsre/stickers/compare/v1.0.0...v1.1.0) (2022-02-26)
### ⚠ BREAKING CHANGES
